...
def decode_access_token(token: str) -> Optional[Dict[str, Any]]:
    """
    Decode and validate a JWT access token using the application's secret key and algorithm.
...
def get_current_user(
    ...
    """
    FastAPI dependency to authenticate requests via Bearer token and retrieve the current user from Oracle DB.
    """
...
def get_current_active_user(
    ...
    """
    FastAPI dependency to ensure authenticated user has an active account.
    """
